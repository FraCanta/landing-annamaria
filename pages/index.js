      ...
      <div className="w-11/12 mx-auto">
        ...
        <main className="flex flex-col">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="flex flex-col gap-6 pb-10 border-r lg:pr-4">
            ...
            <div className="relative border-l lg:border-l-0 border-r border-b border-t aspect-square lg:w-full lg:h-[60vh] 2xla:h-[60vh] border-main">
              <Image
